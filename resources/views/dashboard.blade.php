...
<body class="font-sans antialiased">
    ...
    <div class="dashboard">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="dash grid sm:grid-cols-2 gap-3 my-5 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="event bg-white grid sm:gap-12 lg:gap-9 gap-9 h-xl">
                    <div><h1 class="text-center text-4xl">Event</h1></div>
                    <div class="px-10"><p>create, edit , delete</p></div>
                    <div class="px-10"><a href="{{ route('events.create') }}" class="bg-red-500 text-Blue px-4 py-2 rounded hover:bg-red-600"> Add Event</a></div>
                </div>
                <div class="mini bg-white grid gap-9 h-xl">
                    <div><h1 class="text-center text-4xl">Ministries</h1></div>
                    <div class="px-10"><p>edit, create, delete (user dan Ministry), export excel</p></div>
                    <div class="px-10"><a href="{{ route('ministry.create') }}" class="bg-red-500 text-Blue px-4 py-2 rounded hover:bg-red-600"> Create Ministry</a></div>
                </div>
                <div class="news bg-white grid sm:gap-12 lg:gap-9 gap-9 h-xl sm:col-span-2">
                    <div><h1 class="text-center text-4xl">News</h1></div>
                    <div class="px-10"><p>Create, Edit, Delete</p></div>
                    <div class="px-10"><a href="{{ route('admin.news.create') }}" class="bg-red-500 text-Blue px-4 py-2 rounded hover:bg-red-600"> Add News</a></div>
                </div>
            </div>
        </div>
    </div>
